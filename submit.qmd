...
```{r}
### FINISH CODE HERE
p <- ggplot(cv_states_today, aes(x=pop_density, y=deathsper100k, size=population)) + geom_point() + geom_smooth() + labs(title = "Population-normalized COVID-19 new deaths (per 100k) vs. population density", x = "Population Density", y = "New Deaths per 100k")
ggplotly(p)
```
